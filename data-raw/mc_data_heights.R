...
mc_data_heights <- as.data.frame(tibble::tribble(
    ...
    .model_const_LOGGER_TOMST_THERMODATALOGGER,             .model_const_SENSOR_TS_T,    "air 200 cm",      NA,
                 ...
                 .model_const_LOGGER_TOMST_TMS,  .model_const_SENSOR_TMS_TMSmoisture,  "soil 0-14 cm",      NA,
         .model_const_LOGGER_TOMST_DENDROMETER,           .model_const_SENSOR_DEND_T, "breast height",      NA,
         .model_const_LOGGER_TOMST_DENDROMETER, .model_const_SENSOR_DEND_TOMSTdendro, "breast height",      NA,
