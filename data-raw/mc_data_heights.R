...
mc_data_heights <- as.data.frame(tibble::tribble(
    ...
    .model_const_LOGGER_TOMST_THERMODATALOGGER,   .model_const_SENSOR_Thermo_T,    "air 200 cm",      NA,
                 ...
                 .model_const_LOGGER_TOMST_TMS,  .model_const_SENSOR_TMS_moist,  "soil 0-15 cm",      NA,
         .model_const_LOGGER_TOMST_DENDROMETER,     .model_const_SENSOR_Dendro_T,    "air 130 cm",      NA,
         .model_const_LOGGER_TOMST_DENDROMETER, .model_const_SENSOR_Dendro_raw,    "air 130 cm",      NA,
                      .model_const_LOGGER_HOBO,     .model_const_SENSOR_HOBO_T,    "air 150 cm",      NA,
             ...
             .model_const_LOGGER_TOMST_TMS_L45,  .model_const_SENSOR_TMS_moist, "soil 30-44 cm",  "_L45",
))
