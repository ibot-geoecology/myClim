...
test_that("mc_prep_crop", {
    ...
    expect_equal(cropped_data$A2E32$loggers[[1]]$sensors$TMS_T1$states$start, lubridate::ymd_h("2020-10-16 08"))
    ...
    expect_equal(cropped_data$A2E32$loggers[[1]]$sensors$TMS_T1$states$end, lubridate::ymd_h("2020-10-16 08"))
