...
test_that("mc_join", {
    ...
    cleaned_data$`91184101`$loggers[[2]]$sensors$TS_T$calibration <- data.frame()
    cleaned_data$`91184101`$loggers[[3]]$sensors$TS_T$calibration <- data.frame()
    ...
    expect_equal(nrow(joined_data$`91184101`$loggers[[1]]$sensors$TS_T$states), 2)
    expect_equal(nrow(joined_data$`91184101`$loggers[[1]]$sensors$TS_T$calibration), 2)
    expect_true(is.na(joined_data$`91184101`$loggers[[1]]$sensors$TS_T$calibration$cor_factor[[2]]))
