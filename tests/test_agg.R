...
test_that("mc_agg logical sensor", {
    ...
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_percentile20$values, c(F, T, F, T))
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_sum$metadata@sensor_id, myClim:::.model_const_SENSOR_integer)
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_sum$values, c(389, 573, 320, 555))
