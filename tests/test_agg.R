...
test_that("mc_agg logical sensor", {
    ...
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_mean$values, c(F, F, F, T))
    ...
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_sum$values, c(294, 304, 130, 422))
