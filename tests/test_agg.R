...
test_that("mc_agg logical sensor", {
    ...
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_mean$values, c(T, T, F, T))
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_percentile20$values, c(F, F, F, T))
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_sum$metadata@sensor_id, myClim:::.model_const_SENSOR_integer)
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_sum$values, c(389, 443, 288, 553))
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_count$values, c(672, 672, 672, 576))
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_count$metadata@sensor_id, "count")
    expect_equal(week_calc_data$localities$`94184102`$sensors$snow_coverage$values, c(1, 1, 1, 576/672))
