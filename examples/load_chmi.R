...
data_items <- list()
data_items$humidity <- mc_read_table_wide(airHumid, sensor_id = "RH_perc", "humidity")
data_items$tmin <- mc_read_table_wide(airTmin, sensor_id = "T_C", "T_min")
data_items$tmax <- mc_read_table_wide(airTmax, sensor_id = "T_C", "T_max")
