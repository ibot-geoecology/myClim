...
example_tms_wideformat_table <- mc_reshape_wide(example_cleaned_tomst_data1, c("A6W79", "A2E32"), c("TMS_T1", "TMS_T2"))
...
example_tms_longformat_table <- mc_reshape_long(example_cleaned_tomst_data1, c("A6W79", "A2E32"), c("TMS_T1", "TMS_T2"))
