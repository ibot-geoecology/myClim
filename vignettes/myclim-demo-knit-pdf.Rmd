...
#>      tag      start                 end  
#> 1 source 2020-12-01 2021-04-07 11:45:00 
#> value
#> D:\\Git\\microclim\\examples\\data\\join\\1deg\\data_94184102_1.csv
...
p <- mc_plot_line(tms.plot,filename = "lines.pdf",sensors = c("TMS_T3","TMS_T1",
                                                              "TMS_TMSmoisture"))
...
![](raster.png){width=600px}

![](lines.png){width=600px}
