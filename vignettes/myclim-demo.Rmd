...
## Matej Helper 
# files_table = read.table("d:/Git/myClim/examples/data/TOMST/files_table.csv",
#                          sep=",",header = T)
# files_table<-files_table[order(files_table$path),]
# 
# fi<-list.files("d:/Git/myClim/examples/data/TOMST/"
#                ,pattern = "data",
#                full.names = T)
# files_table$path<-fi
# write.table(files_table,"d:/Git/myClim/examples/data/TOMST/files_table1.csv",
#                          sep=",",row.names = F)

tms.m <- mc_read_data(files_table = 
                        "d:/Git/myClim/examples/data/TOMST/files_table1.csv",
                      localities_table =
                        "d:/Git/myClim/examples/data/TOMST/localities_table.csv")

# tms.m <- mc_read_data(files_table = 
#                         "/examples/data/TOMST/files_table.csv",
#                       localities_table =
