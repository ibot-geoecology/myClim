...
tms.d <- mc_read_files(".", dataformat_name="TOMST",recursive = F)

# read from data.frame
meteo.table<-readRDS("airTmax_meteo.rds") # wide format data frame 
meteo<-mc_read_wide(meteo.table,sensor_id = "T_C", sensor_name = "airTmax")
...
tms.m <- mc_read_data(files_table, localities_table)
...
* **Joining in time**  Not implemented yet. We are working on it. This function will help to  interactively join the the time-series from multiple downloads. 
